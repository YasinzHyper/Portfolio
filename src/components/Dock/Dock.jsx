...
export function BottomDock() {
  return (
    <div className="fixed bottom-10 w-full">
      <Dock magnification={60} distance={120} className="border-x-2 border-y-2 border-slate-300/50 border-dashed">
        <DockIcon size={50} className="bg-black/10 dark:bg-white/10 p-3">
